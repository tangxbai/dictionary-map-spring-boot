...
/**
 * An abstract property manager for initializing the set of property access for different bean objects.
 *
 * @author tangxbai
 * @since 1.0.0
 */
abstract class AbstractManager extends BeanMapper {

    final ParameterBridge bridge;

    public AbstractManager( ParameterBridge bridge ) {
        super( Language.class, Dictionary.class );
        this.bridge = bridge;
    }
